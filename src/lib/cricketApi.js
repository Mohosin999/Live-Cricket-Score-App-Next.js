...
//   try {
//     const response = await cricketApi.get("/matches/v1/international");
//     return response.data;
//   } catch (error) {
//     console.error("Error fetching live matches:", error);
//     throw error;
...
//   try {
//     const response = await cricketApi.get("/matches/v1/domestic");
//     return response.data;
//   } catch (error) {
//     console.error("Error fetching live matches:", error);
//     throw error;
...
// export const getWomenMatches = async () => {
//   try {
//     const response = await cricketApi.get("/matches/v1/women");
//     return response.data;
//   } catch (error) {
//     console.error("Error fetching live matches:", error);
//     throw error;
...
//   try {
//     const response = await cricketApi.get("/matches/v1/league");
//     return response.data;
//   } catch (error) {
//     console.error("Error fetching live matches:", error);
//     throw error;
