...
// export const getUpcomingLeagueMatches = async () => {
//   try {
//     const response = await cricketApi.get("schedule/v1/league");
//     return response.data;
//   } catch (error) {
//     console.error("Error fetching upcoming matches:", error);
//     throw error;
...
const cache = new NodeCache({ stdTTL: 600 }); // Cache expires in 60 seconds
